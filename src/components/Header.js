  ...
  return (
    <div className='flex justify-between items-center p-2 sticky top-0 z-50 w-full bg-white'>
        ...
        <div className="col-span-8 w-[40%] text-center flex items-center">
            ...
            <input className='border border-solid border-gray-300 px-4 py-2 w-[100%] rounded-l-full' type="text" value={searchText} onChange={(e)=>setSearchText(e.target.value)} onFocus={()=>{setSearchResultStatus(navStatus?false:true)}} onBlur={()=>{setTimeout(() => {
